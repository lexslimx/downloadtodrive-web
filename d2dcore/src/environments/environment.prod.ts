export const environment = {
  ...
  loginUrl: 'https://downloadtodriveapi.azurewebsites.net/account/api/account/login',
  registrationIUrl: 'https://downloadtodriveapi.azurewebsites.net/api/account/register',
